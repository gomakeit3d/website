...
const Logo = styled(Link)`
  ...
  @media (max-width: 768px) {
    img {
      height: 50px; /* Slightly smaller on mobile but still bigger than before */
    }
  }
`;
...
const Navbar = () => {
  ...
  return (
    <NavContainer scrolled={scrolled}>
      <NavContent>
        <Logo to="/">
          <img src={logoImage} alt="GoMakeIt Logo" />
        </Logo>
      ...
      >
        ...
        <MobileNavLinks>
          <MobileNavLink to="/" active={location.pathname === '/' ? 1 : 0} onClick={closeMobileMenu}>
            Home
          </MobileNavLink>
          <MobileNavLink to="/services" active={location.pathname === '/services' ? 1 : 0} onClick={closeMobileMenu}>
            Services
          </MobileNavLink>
          <MobileNavLink to="/portfolio" active={location.pathname === '/portfolio' ? 1 : 0} onClick={closeMobileMenu}>
            Portfolio
          </MobileNavLink>
          <MobileNavLink to="/contact" active={location.pathname === '/contact' ? 1 : 0} onClick={closeMobileMenu}>
            Contact
          </MobileNavLink>
        </MobileNavLinks>
      </MobileMenu>
